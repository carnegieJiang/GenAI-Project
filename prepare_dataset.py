...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dataset-root",
        default="data/stylebooth_dataset",
        help="Root directory of the extracted StyleBooth dataset.",
    )
    parser.add_argument(
        "--train-csv",
        default="data/stylebooth_dataset/train.csv",
        help="Path to the StyleBooth train.csv file.",
    )
    parser.add_argument(
        "--output-dir",
        default="data/stylebooth_subset",
        help="Directory where the subset metadata will be written.",
    )
    parser.add_argument("--max-samples", type=int, default=250, help="Maximum number of rows to keep.")
