...
python3 ./train.py \
    ...
    --num_sample_images 2 \
    --mixed_precision no \
    --seed 42 --freeze_text_encoder --freeze_vae --use_dit --use_t5 --model_type decouple --run_name decouple_dit_frozen_t5 --text_guidance_scale 1.0
...
python3 ./train.py \
    ...
    --num_sample_images 2 \
    --mixed_precision no \
    --seed 42 --freeze_text_encoder --freeze_vae --use_dit --model_type decouple --run_name decouple_dit_frozen_add_noise --use_noise --text_guidance_scale 1.0
...
python3 ./train.py \
    ...
    --num_sample_images 2 \
    --mixed_precision no \
    --seed 42 --freeze_text_encoder --freeze_vae --use_dit --model_type decouple --run_name decouple_dit_frozen_advanced_loss --use_advanced_loss --text_guidance_scale 1.0
