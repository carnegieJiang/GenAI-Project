...
python3 ./train.py \
    --data_path /home/chealisa/Desktop/genAI/stylebooth_subset/metadata.csv \
    --output_dir /home/chealisa/Desktop/genAI/model/decouple_outputs/hptune_test/frozen_pretrained \
    --resolution 512 \
    --batch_size 4 \
    --lr 2.5e-6 \
    --weight_decay 1e-2 \
    ...
    --num_sample_images 2 \
    --mixed_precision no \
    --seed 42 --freeze_text_encoder --freeze_vae --use_dit --model_type decouple --run_name decouple_dit_frozen_pretrained --pretrained_dit_ckpt /home/chealisa/Desktop/genAI/model/flow_outputs/hptune_test/frozen/final_model.pt
